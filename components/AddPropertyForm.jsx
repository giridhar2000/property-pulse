  ...
  return (
    <form>
      ...
      <div className="mb-4">
        ...
        <Select options={["Apartment","Condo","House","Cabin Or Cottage","Room","Studio","Other"]} placeholder={'Select Property Type'}/>
      </div>
      <div className="mb-4">
      ...
      <div className="mb-4 flex flex-wrap">
        ...
        <div className="w-full sm:w-1/3 pl-2">
          <label for="square_feet" className="block text-gray-700 font-bold mb-2">
            Square Feet
          </label>
          <input
            type="number"
      ...
      <div className="mb-4">
        <label for="seller_name" className="block text-gray-700 font-bold mb-2">
          Seller Name
        </label>
        <input
          type="text"
      ...
      <div className="mb-4">
        <label for="seller_email" className="block text-gray-700 font-bold mb-2">
          Seller Email
        </label>
        <input
          type="email"
      ...
      <div className="mb-4">
        <label for="seller_phone" className="block text-gray-700 font-bold mb-2">
          Seller Phone
        </label>
        <input
          type="tel"
